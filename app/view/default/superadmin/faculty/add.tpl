...
<div class="col-lg-12">
	<div class="panel shadow">
		<div class="panel-body">
    		...
    		<form action="<?= u('/superadmin/faculty/add') ?>" method="post" autocomplete="off" class="form-horizontal">
        		...
        		<div class="form-group clearfix">
					...
					<div class="col-sm-9">
						<button type="submit" name="add_faculty" class="btn btn-success"><span class="fa fa-check-circle fa-lg"></span> <?= lang('submit') ?></button>
