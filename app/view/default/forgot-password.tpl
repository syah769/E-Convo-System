...
<div class="col-lg-offset-3 col-lg-6">
	<div class="panel shadow">
		<div class="panel-body">
			<form action="<?= u('/forgot-password') ?>" method="post" autocomplete="off" class="form-horizontal">
				...
				<div class="form-group clearfix">
					...
					<div class="col-sm-9">
						<button type="submit" name="fpasswd" class="btn btn-success"><i class="fa fa-check-circle fa-lg"></i> <?= lang('submit') ?></button>
